...
const text = {
  ...
  fr: {
    ...
    title: "A propos de ce tableau de sante client",
    lede:
      "Ce site est un projet data cloud qui repond a une question business simple : quels clients risquent de partir et quels patterns sont lies a ce risque ?",
    actions: {
      customers: "Explorer les clients",
      dashboard: "Retour au tableau",
      github: "Projet GitHub",
      data: "Source des donnees",
    },
    whatTitle: "Fonction du site",
    whatBody: [
      "Le tableau montre des insights de churn client. Le churn signifie qu'un client quitte un service. Le projet estime le risque de churn, met en avant les clients a haut risque, montre le revenu a risque et liste les principaux facteurs de churn.",
      "C'est un projet portfolio : assez simple pour etre compris, mais assez complet pour montrer un vrai workflow data de l'ingestion jusqu'a l'explication business.",
    ],
    readTitle: "Comment lire les resultats",
    readBody: [
      "Une forte probabilite de churn signifie que le modele a trouve des patterns proches de clients qui ont deja quitte. C'est un signal d'alerte, pas une certitude.",
      "Les facteurs de churn indiquent quelles variables ont le plus influence le modele. Ils aident a expliquer le modele, mais ne prouvent pas qu'un facteur cause directement le churn.",
    ],
    riskTitle: "Comment le risque client est calcule",
    riskBody: [
      "Le pipeline Python nettoie chaque ligne client et transforme les champs utiles en variables utilisables par le modele. Les champs numeriques comme l'anciennete, les charges mensuelles et les charges totales sont mis a l'echelle. Les champs texte comme le type de contrat, le service internet et la methode de paiement sont convertis en colonnes numeriques avec one-hot encoding.",
      "Le modele retourne une probabilite de churn entre 0 et 1 pour chaque client. L'application transforme ensuite cette probabilite en etiquette simple : risque faible sous 40%, risque moyen entre 40% et 70%, et risque eleve a partir de 70%.",
    ],
    mlTitle: "Fonction de machine learning utilisee",
    mlBody: [
      "Le projet utilise LogisticRegression de scikit-learn dans un Pipeline. La regression logistique est une fonction de machine learning pour la classification binaire, c'est-a-dire qu'elle predit un resultat parmi deux choix. Ici, le resultat est churn : Oui ou Non.",
      "Elle est utilisee parce qu'elle est simple, rapide, interpretable et produit des probabilites. C'est donc un bon premier modele pour un tableau business, car on peut expliquer quelles variables augmentent ou reduisent le risque.",
    ],
    airbyteTitle: "Comment Airbyte est utilise",
    airbyteBody: [
      "Airbyte Cloud est l'outil d'ingestion. Il se connecte au fichier CSV public avec une source File HTTPS, puis ecrit les donnees dans Neon PostgreSQL sous raw.customer_churn.",
      "Airbyte n'entraine pas le modele. Son role est de deplacer les donnees de facon fiable vers la base. Apres le chargement de la table raw par Airbyte, GitHub Actions lance le pipeline Python qui nettoie, entraine et ecrit les tables analytics.",
    ],
    workflowTitle: "Workflow",
    technologyTitle: "Technologies utilisees",
    databaseTitle: "Tables de base de donnees",
    footer:
      "Construit avec Airbyte Cloud, Neon PostgreSQL, GitHub Actions, Python, Next.js, Vercel et OpenAI.",
    workflowSteps: [
      {
        title: "Collecter les donnees",
        body: "Airbyte Cloud lit le CSV public Telco Customer Churn et le charge dans Neon PostgreSQL.",
      },
      {
        title: "Stocker les donnees brutes",
        body: "La base conserve les lignes originales dans le schema raw afin que le pipeline ait un point de depart propre.",
      },
      {
        title: "Nettoyer et preparer",
        body: "Un script Python normalise les noms de colonnes, convertit charges et anciennete en nombres, remplit les valeurs manquantes et cree des variables utiles.",
      },
      {
        title: "Entrainer le modele",
        body: "Scikit-learn entraine une regression logistique qui estime la probabilite de churn de chaque client.",
      },
      {
        title: "Publier les analyses",
        body: "Le pipeline ecrit les tables pretes pour le tableau dans le schema analytics : KPI, predictions et facteurs de churn.",
      },
      {
        title: "Expliquer les resultats",
        body: "Le tableau Vercel montre les metriques business, et le chatbot OpenAI repond avec les tables analytics.",
      },
    ],
    technologies: [
      ["Airbyte Cloud", "Deplace les donnees du CSV public vers PostgreSQL."],
      ["Neon PostgreSQL", "Stocke les donnees brutes, nettoyees, les predictions, les KPI et l'historique."],
      ["GitHub Actions", "Lance le workflow Python de transformation et d'entrainement dans le cloud."],
      ["Python", "Nettoie les donnees et entraine le modele de prediction du churn."],
      ["pandas", "Charge, nettoie et reformate les lignes clients."],
      ["scikit-learn", "Construit le modele de machine learning."],
      ["Next.js", "Alimente les pages du tableau et les routes API."],
      ["Vercel", "Heberge l'application web."],
      ["OpenAI API", "Transforme le contexte analytique en reponses simples."],
    ],
    tables: [
      ["raw.customer_churn", "Lignes originales chargees par Airbyte."],
      ["analytics.customer_health", "Lignes clients nettoyees pour l'analyse."],
      ["analytics.churn_predictions", "Une ligne par client avec probabilite de churn et niveau de risque."],
      ["analytics.kpi_summary", "Cartes du tableau comme le taux de churn et le revenu a risque."],
      ["analytics.churn_drivers", "Variables qui ont le plus influence le modele."],
    ],
  },
};
